...
function html_article_main($article_a)
{
    ...
    <section class="article">
        <article>
            ...
            <h2>$hook</h2>
            <div>
                <a href="?page=favorite&action=add&article_id=$art_id" class="favorite-link">Ajouter aux favoris</a>
            </div>
            <div class="media_article"> <img src="$image_path" alt="$title" width="600"> </div>
            <div>$date</div>
            <div>$content</div>
